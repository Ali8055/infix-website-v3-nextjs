      ...
      <Popover modal open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <button
            ...
            className="flex flex-col items-center gap-2 rounded-l-lg bg-primary px-2 py-5 text-xl font-semibold text-primary-foreground"
          >
            <span className="[writing-mode:vertical-lr] text-sm">
              Let&apos;s Talk
            </span>
